  ...
  private void initComponents() {
    ...
    private void loadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadActionPerformed
        ...
        try {
            ...
            decryptedMsg = decrypt(all, keyBytes);
    ...
    private String decrypt(final String encryptedValue, byte[] secretKey) {
        String decryptedValue = null;
        try {
            String[] arr = encryptedValue.split(":");
            byte[] ivBytes = Base64.getDecoder().decode(arr[0]);
            byte[] decryptedBytes = Base64.getDecoder().decode(arr[1]);

            decryptedValue = new String(AESGoodImplementation.decrypt(secretKey, ivBytes, decryptedBytes));
